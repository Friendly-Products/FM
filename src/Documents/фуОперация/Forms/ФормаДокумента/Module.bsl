...
Процедура ОтображениеЭлементовФормыПоУмолчанию();
	...
	мИДКонтрагента = Объект.Контрагент.ИДКонтрагента;
...
&НаКлиенте
Процедура СуммаНачисленияПриИзменении(Элемент)
	СуммаПлатежаПриИзмененииНаСервере();
КонецПроцедуры

&НаКлиенте
Процедура КурсУправленческойВалютыПриИзменении(Элемент)
	СуммаПлатежаПриИзмененииНаСервере();
КонецПроцедуры
...
Процедура СуммаПлатежаПриИзмененииНаСервере()
	...
	Объект.СуммаПлатежаВВалютеУУ = ДокументОбъект.РасчитатьСуммуПлатежаВВалютеУУ(Объект.СуммаПлатежа,
	 																			 Объект.КурсУправленческойВалюты,
																				 Объект.КурсОперации); 
КонецПроцедуры
